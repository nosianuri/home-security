      ...
      <div>
        ...
        <div className='lg:flex p-5 justify-between'>
          ...
          <div className='offer-btn-box'>
            <button className='btn request-btn text-white mb-3 text-2xl mt-2'><a href="/#topform"><i className="fa-solid fa-up-right-from-square"></i><span className='pl-2 '>Reaquest a quote</span></a></button>
            <div>
        ...
        <div className='lg:flex justify-between p-5 bg-slate-400'>
          <div className='offer-btn-box'>
            <button className='btn bg-white below-btn mr-2'><i className="fa-solid fa-truck-monster pr-2"></i>Professional Installation</button>
            <button className='btn bg-white below-btn mr-2'><i className="fa-solid fa-shield-halved pr-2"></i>24x7 Monitoring</button>
            <button className='btn bg-white below-btn mr-2'><i class="fa-solid fa-mobile-screen pr-2"></i>Mobile App</button>
            <button className='btn bg-white below-btn'><i className="fa-solid fa-fire pr-2"></i>Fire Monitoring</button>
          </div>
          <div>
