            ...
            <div className='banner-format'>
                <div className='d-flex justify-content-center article'>
                    <div className='article-lead ml-16'>
                        <h1 className='text-6xl text-white font-bold mb-5'>Send us your request Today! </h1>
                        <h2 className='text-white text-4xl leading-normal'>Fill our <a href="/#left-form" className='font-bold text-5xl text-[#1e73be]'>Form</a> give us a <a href="tel:+18554301263" className='font-bold text-5xl text-[#1e73be]'>Call</a> to directly assist Intelligent Home or Business Security System.</h2>
                        <ul className='text-white pl-10 text-lg text-2xl mt-5'>
                    ...
                    <div>
                        ...
                        <div className='d-flex justify-content-center'>
                            <div className='banner-form form-group'>
                                <h4>Experience Smarter Security with Vivint-monitored Home Security Systems</h4>
